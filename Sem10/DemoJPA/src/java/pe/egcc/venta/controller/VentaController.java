...
import pe.egcc.venta.controller.util.JsfUtil;
import pe.egcc.venta.controller.util.PaginationHelper;
import pe.egcc.venta.service.VentaFacade;
...
public class VentaController implements Serializable {
  ...
  @EJB
  private pe.egcc.venta.service.VentaFacade ejbFacade;
  ...
  public static class VentaControllerConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
      ...
      if (object instanceof Venta) {
        ...
        return getStringKey(o.getVenId());
      } else {
