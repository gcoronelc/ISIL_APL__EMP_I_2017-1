...
public class PrincipalView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar reporte por ID");
	 ...
	 private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
		try {
			...
			dtm.setRowCount(0);
			// LLenar la tabla
			List<Reporte> lista = new ReporteDAO().readForName(txtDato.getText());
			for (Reporte a : lista) {
  ...
  private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
	...
	private void InitTable() {
		tableModel = new DefaultTableModel(new String[]{"ID", "LOCAL", "TIPO INCIDENCIA", "GRAVEDAD", "DESCRIPCION","FECHA", "HORA", "RECOMENDACIONES"}, 0);
		tblData.setModel(tableModel);
		tblData.getColumnModel().getColumn(0).setMinWidth(10);
		...
		tblData.getColumnModel().getColumn(3).setMinWidth(50);
		tblData.getColumnModel().getColumn(3).setMaxWidth(00);
